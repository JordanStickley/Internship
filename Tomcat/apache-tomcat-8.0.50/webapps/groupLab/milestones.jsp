					...
					<div class="well">
						<div class="row" id="title">
							<div class="form-group col-sm-12">
								...
								<input class="form-control" type="text" id="titleOfMilestone" placeholder="Title" />
							</div>
							<div class="form-group col-sm-12">
								<label class="control-label" for="descriptionOfMilestone">Description</label>
								<input class="form-control" type="text" id="descriptionOfMilestone" placeholder="Description" />
							</div>
							<div class="form-group col-sm-12">
								<label class="control-label" for="milestoneMaxPoints">Max Points</label>
								<input class="form-control" type="text" id="milestoneMaxPoints" placeholder="Max Points" />
							</div>
							<div class="form-group col-sm-12">
								<p class="center-text">
									<button type="button" id="addMilestone" class="btn btn-primary">Add Milestone</button>
								</p>
							</div>
						</div>
					</div>
