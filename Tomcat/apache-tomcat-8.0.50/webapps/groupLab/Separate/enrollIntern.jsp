...
<body onload="setActiveLink('enrollInternLink');">
		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<div class="col-sm-12 no-padding">
					...
					<div class="well">
						<div class="row" id="memberInfo">
							<div class="form-group col-sm-6">
									...
									<input id="myInput" class="form-control" type="text" id="teamMemberName" placeholder="Team Member Full Name" />	
							</div>
						</div>
					</div>
					...
					<p class="text-center">
						<button id="internSubmit" class="btn btn-primary" type="button" onclick="enrollIntern();" >Enroll</button>
					</p>
