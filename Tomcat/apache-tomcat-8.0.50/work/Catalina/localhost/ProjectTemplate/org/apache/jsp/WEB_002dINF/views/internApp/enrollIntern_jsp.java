 ...
 * Generated at: 2018-06-20 21:59:12 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<button class=\"btn btn-success\" id=\"successBtn\" type=\"button\">Enroll</button>\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\tlet alertManager = registry.byId('alertManager');\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tquery('#errorBtn').on('click', function() {\t\r\n");
      out.write("\t\t\t\t\tclearAlerts();\r\n");
      out.write("\t\t\t\t\talertManager.addError({ message: \"Error Message\", title : \"Error Title\", cssClass : 'myclass', position : 'myam' });\t\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tquery('#warningBtn').on('click', function() {\r\n");
      out.write("\t\t\t\t\tclearAlerts();\r\n");
      out.write("\t\t\t\t\talertManager.addWarning({ message: \"Warn Message\", title : \"Warn Title\", hide : false, position : 'myam', duration: 5000 });\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t   \r\n");
      out.write("\t\t\t\tquery('#infoBtn').on('click', function() {\r\n");
      out.write("\t\t\t\t\tclearAlerts();\r\n");
      out.write("\t\t\t\t\talertManager.addInfo({ message: \"Info Message\", title : \"Info Title\", hide : false, id : 'succ', position: 'myam' });\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tquery('#successBtn').on('click', function() {\r\n");
      out.write("\t\t\t\t\tclearAlerts();\r\n");
      out.write("\t\t\t\t\tconsole.log('hi');\r\n");
      out.write("\t\t\t\t\talertManager.addSuccess({ message: \"Success Message\", title : \"Success Title\", hide : false, id : 'succ' });\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tfunction clearAlerts() {\r\n");
      out.write("\t\t\t\t\talertManager.clear(alertManager.types.danger);\r\n");
      out.write("\t\t\t\t\talertManager.clear(alertManager.types.success);\r\n");
      out.write("\t\t\t\t\talertManager.clear(alertManager.types.warning);\r\n");
      out.write("\t\t\t\t\talertManager.clear(alertManager.types.info);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
