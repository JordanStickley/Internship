...
<c:set value="/resources/css/oreillybs-3.3.5r2.min.css"
	var="bootstrapUrl" />
<c:set value="/resources/css/oreillybs-dojo-r13.min.css"
	var="dojoOverrideUrl" />
...
<script type="text/javascript">
	var dojoConfig = {
		...
		packages : [ {
			name : "dojo",
			location : "${dojoUrl}dojo"
		}, {
			name : "dijit",
			location : "${dojoUrl}dijit"
		}, {
			name : "oreilly",
			location : "${dojoUrl}oreilly"
		}, {
			name : "dgrid",
			location : "${dojoUrl}dgrid"
		}, {
			name : "dojox",
			location : "${dojoUrl}dojox"
		}, {
			name : "bootstrap",
			location : "${dojoUrl}bootstrap"
		}, {
			name : "put-selector",
			location : "${dojoUrl}put-selector"
		}, {
			name : "xstyle",
			location : "${dojoUrl}xstyle"
		}, {
			name : "dbind",
			location : "${dojoUrl}dbind"
		}, {
			name : "dstore",
			location : "${dojoUrl}dstore"
		}, {
			name : "local",
...
<body class="tundra">
	<div id="bodyContentTile" class="container">
		...
		<!-- project template has 1 row with a nav on the left and the main body on the right -->
			<div class="row">
				<div class="col-sm-2">
					<tiles:insertAttribute name="carPartsMenu" />
				</div>
				<div class="col-sm-10">
